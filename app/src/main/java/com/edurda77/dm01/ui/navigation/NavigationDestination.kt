...
import com.edurda77.dm01.domain.utils.NEWS_MORE_SCREEN
import com.edurda77.dm01.domain.utils.NEWS_SCREEN
import com.edurda77.dm01.domain.utils.NOTES_SCREEN
import com.edurda77.dm01.domain.utils.NOTE_MORE_SCREEN
...
sealed class NavigationDestination (val destination: String){
    ...
    data object NewsMoreScreenDestination: NavigationDestination("$NEWS_MORE_SCREEN/{idNews}")
    data object NoteMoreScreenDestination: NavigationDestination("$NOTE_MORE_SCREEN/{idNote}")
}
